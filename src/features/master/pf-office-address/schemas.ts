...
/** Create/edit form for a PF office address. */
export const pfOfficeAddressSchema = z.object({
  // Office information
...
export type PfOfficeAddressFormValues = z.infer<typeof pfOfficeAddressSchema>
