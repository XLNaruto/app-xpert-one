...
interface PfOfficeAddressFormFieldsProps {
  register: UseFormRegister<PfOfficeAddressFormValues>
  control: Control<PfOfficeAddressFormValues>
  errors: FieldErrors<PfOfficeAddressFormValues>
...
/**
 * The PF office address field grid — who the office is, how to reach it and
 * where it sits. District cascades off the selected state.
 */
export function PfOfficeAddressFormFields({
  register,
  control,
  errors,
  stateOptions,
