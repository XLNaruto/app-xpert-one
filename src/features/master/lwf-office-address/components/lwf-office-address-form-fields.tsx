...
interface LwfOfficeAddressFormFieldsProps {
  register: UseFormRegister<LwfOfficeAddressFormValues>
  control: Control<LwfOfficeAddressFormValues>
  errors: FieldErrors<LwfOfficeAddressFormValues>
...
/**
 * The LWF office address field grid — who the office is, how to reach it and
 * where it sits. District cascades off the selected state.
 */
export function LwfOfficeAddressFormFields({
  register,
  control,
  errors,
  stateOptions,
