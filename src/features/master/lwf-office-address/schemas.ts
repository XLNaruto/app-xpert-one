...
/** Create/edit form for an LWF office address. */
export const lwfOfficeAddressSchema = z.object({
  // Office information
...
export type LwfOfficeAddressFormValues = z.infer<typeof lwfOfficeAddressSchema>
