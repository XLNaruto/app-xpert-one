...
/** Create/edit form for an employment exchange office address. */
export const employmentExchangeOfficeAddressSchema = z.object({
  // Office information
...
export type EmploymentExchangeOfficeAddressFormValues = z.infer<typeof employmentExchangeOfficeAddressSchema>
