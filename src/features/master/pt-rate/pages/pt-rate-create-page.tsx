...
interface PtRateCreatePageProps {
  /**
   * Encrypted PT rate id from the `?data=` search param. When present the page
...
export function PtRateCreatePage({ data }: PtRateCreatePageProps) {
  ...
  return (
    <div>
      <PageHeader
        title={isEdit ? 'Edit PT Rate' : 'Add PT Rate'}
        description={
          isEdit
            ? 'Update this Professional Tax rate and its salary slabs'
            : 'Configure Professional Tax rate details and salary slabs'
        }
        actions={
