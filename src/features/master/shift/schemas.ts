...
export const shiftSchema = z
  .object({
    ...
    earlyExitGraceMinutes: optionalInt(720, 'Enter whole minutes, up to 720'),
    ...
    /**
     * Active/inactive. Carried by the form but not shown on it — a new shift is
     * created active, and an edit sends back whatever the record already holds,
     * so nothing is silently flipped by a save.
     */
    status: z.boolean(),
  })
