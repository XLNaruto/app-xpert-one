...
/** Create/edit form for an ESIC office address. */
export const esicOfficeAddressSchema = z.object({
  // Office information
...
export type EsicOfficeAddressFormValues = z.infer<typeof esicOfficeAddressSchema>
