...
interface EsicOfficeAddressFormFieldsProps {
  register: UseFormRegister<EsicOfficeAddressFormValues>
  control: Control<EsicOfficeAddressFormValues>
  errors: FieldErrors<EsicOfficeAddressFormValues>
...
/**
 * The ESIC office address field grid — who the office is, how to reach it and
 * where it sits. District cascades off the selected state.
 */
export function EsicOfficeAddressFormFields({
  register,
  control,
  errors,
  stateOptions,
